...
class ConnectionCredentialsTest {
  ...
  void testConnectionCredentialsCreation() {
    ...
    ConnectionCredentials credentials = new ConnectionCredentials(hostname, port, database,
        username, password, databaseFile);
  ...
  @Test
  void testEquality() {
    ConnectionCredentials credentials1 = new ConnectionCredentials("localhost", 3306, "testdb",
        "user", "pass", null);
    ConnectionCredentials credentials2 = new ConnectionCredentials("localhost", 3306, "testdb",
        "user", "pass", null);
    ConnectionCredentials credentials3 = new ConnectionCredentials("otherhost", 3306, "testdb",
        "user", "pass", null);
