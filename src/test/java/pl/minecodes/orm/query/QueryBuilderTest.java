...
class QueryBuilderTest {
    ...
    void setUp() {
        ...
        repository.executeUpdate("CREATE TABLE IF NOT EXISTS query_test (id INTEGER PRIMARY KEY AUTOINCREMENT, name TEXT, age INTEGER, score REAL, active INTEGER)");
    ...
    void testWhereInEmpty() {
        List<QueryTestEntity> result = repository.query()
                .where("name", Operator.IN, Arrays.asList())
                .execute();
